...
Pass the FCC General class license exam. All questions, all answers, in a study app.
...
| Section | Topic | Exam Qs | Pool Size |
|:-------:|-------|:-------:|:---------:|
| G1 | Commission's Rules | 5 | 57 |
...
1. **Open the [Study App](https://jeremy-windsor.github.io/general-study-guide/apps/study-app/)**
2. **Quick Study** — flashcards focusing on your weak spots
3. **Study by Section** — drill individual subelements and groups
4. **Practice Exams** — full 35-question timed tests
5. **Weak Areas** — review questions you've gotten wrong
...
- **Use the formula reference** — tap the 📐 button in the app for quick formula access
